...
TOKEN = "7309243160:AAEAjEFTYjYcNKa-zEnqPerBy8OxV5k9qec"
OWNER_ID = 7345217777
# --- New Configuration ---
AUTHORIZATION_CONTACT = "@nairobiangoon1"
OFFICIAL_GROUP_LINK = "https://t.me/+ym619Khe05QyY2U0"
...
AUTHORIZED_GROUP_ID = -1002910998948
...
BULLET_GROUP_LINK = "https://t.me/+ym619Khe05QyY2U0"
OFFICIAL_GROUP_LINK = "https://t.me/+ym619Khe05QyY2U0"
DEV_LINK = "https://t.me/nairobiangoon1"
...
async def razorpay_gate_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    BULLET_GROUP_LINK = "https://t.me/+ym619Khe05QyY2U0"  # your clickable bullet link
    bullet_link = f"<a href='{BULLET_GROUP_LINK}'>[⌇]</a>"
...
# ===== Config =====
BULLET_GROUP_LINK = "https://t.me/+ym619Khe05QyY2U0"
DEVELOPER_NAME = "Nairobiangoon"
DEVELOPER_LINK = "https://t.me/nairobiangoon1"
...
async def background_check(cc_normalized, parts, user, user_data, processing_msg):
    ...
    try:
        ...
        final_text = (
            ...
            f"</pre>\n\n"
            f"𝐃𝐄𝐕 ➵ <a href=\"tg://resolve?domain=Nairobiangoon1\">Nairobiangoon</a>\n"                   
...
async def process_pp(update: Update, context: ContextTypes.DEFAULT_TYPE, payload: str):
    ...
    try:
        ...
        # developer branding
        DEVELOPER_NAME = "Nairobiangoon"
        DEVELOPER_LINK = "https://t.me/nairobiangoon"
        developer_clickable = f'<a href="{DEVELOPER_LINK}">{DEVELOPER_NAME}</a>'
...
async def run_braintree_check(user, cc_input: str, full_card: str, processing_msg):
    start_time = time.time()
    developer_clickable = '<a href="https://t.me/nairobiangoon1">Nairobiangoon</a>'
...
async def gate_worker(update: Update, url: str, msg, user_id: int):
    ...
    developer_clickable = "[Nairobiangoon](https://t.me/Nairobiangoon1)"
    bullet = "[⌇]"
...
# Clickable bullet
BULLET_LINK = '<a href="https://t.me/+ym619Khe05QyY2U0">[⌇]</a>'
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_message = (
        ...
        f"{BULLET_LINK} 𝐁𝐨𝐭 𝐁𝐲 ➳ <a href='tg://resolve?domain=Nairobiangoon1'>Nairobiangoon</a>\n"
        "――――――――――――――――"
    )
...
OWNER_ID =  7345217777                    # Your Telegram user ID
...
async def block_unauthorized(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "📩 Contact @Nairobiangoon1 to get access.\n"
        "🔗 Official group: https://t.me/+ym619Khe05QyY2U0"
    )
...
def restricted(func):
    ...
    async def wrapped(update: Update, context: ContextTypes.DEFAULT_TYPE, *args, **kwargs):
        ...
        if chat_type != "private" and chat_id not in AUTHORIZED_CHATS and user_id != OWNER_ID:
            await update.message.reply_text(
                "🚫 This group is not authorized to use this bot.\n\n"
                "📩 Contact @nairobiangoon to get access.\n"
                "🔗 Official group: https://t.me/+ym619Khe05QyY2U0"
            )
            return
